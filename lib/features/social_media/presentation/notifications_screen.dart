...
/// Centro de Notificaciones (Pantalla 39).
///
/// 1. Carga el historial de notificaciones vía GET /notifications/
/// 2. Se conecta al WebSocket wss://.../ws/notifications/?token=... para recibir
///    avisos en tiempo real sin necesidad de refrescar.
...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Future<void> _connectWebSocket() async {
    ...
    _wsSub = _ws.messages.listen((data) {
      // El servidor envía { "type": "notification", "notification": {...} }
      if (data['type'] == 'notification' && data['notification'] != null) {
        ...
        if (mounted) {
          setState(() {
            // Inserta al inicio de la lista para que aparezca primero
