...
class ResourceUploadNotifier extends StateNotifier<AsyncValue<TeacherResource?>> {
...
final resourceUploadProvider = StateNotifierProvider<ResourceUploadNotifier, AsyncValue<TeacherResource?>>((ref) {
	return ResourceUploadNotifier(ref.read(teacherRepositoryProvider));
});

final resourceLoadingProvider = Provider<bool>((ref) => ref.watch(resourceUploadProvider).isLoading);