...
/*//Cursos-Idiomas
  ...
  Future<LanguageModel> createLanguage({required String name, required String code, String? flagIconUrl});
  Future<void> updateLanguage({required int id, required String name, required String code, String? flagIconUrl});
  Future<void> deleteLanguage(int id);
  
  // ─── Cursos ──────────────────────────────────────
  Future<List<CourseModel>> fetchCourses();
  Future<void> createCourse(Map<String, dynamic> data);
  Future<void> updateCourse(int id, Map<String, dynamic> data);
