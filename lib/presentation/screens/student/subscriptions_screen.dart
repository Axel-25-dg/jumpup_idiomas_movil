                  ...
                  background: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('Desbloquea todo el potencial de JumpUp', style: TextStyle(color: Colors.white.withOpacity(0.7), fontSize: 14)),
                      ],
                    ),
                  ),
                ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text('Vence: ${subscription.endDate ?? "N/A"}', style: TextStyle(color: Colors.white.withOpacity(0.8), fontSize: 12)),
              ],
            ),
          ),
        ],
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(plan.durationLabel ?? '${plan.durationDays ?? 30} días', style: TextStyle(color: Colors.white.withOpacity(0.7), fontSize: 13)),
                  ],
                ),
                Column(
