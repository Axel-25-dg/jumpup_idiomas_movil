...
import 'package:jumpup_app/presentation/screens/admin/admin_profile_screen.dart';
import 'package:jumpup_app/presentation/screens/admin/broadcast_email_screen.dart'; // ✅ NUEVO IMPORT
...
class _AdminOpsTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _BaseTab(
      title: l10n.adminOps,
      children: [
        // ✅ NUEVO: Envío de Correos (arriba de Certificados)
        _ActionCard(
          icon: Icons.email_rounded,
          title: 'Envío de Correos',
          subtitle: 'Gestiona envíos masivos de correos',
          color: _AdminTokens.secondary,
          onTap:
              () => Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => const BroadcastEmailScreen(),
                ),
              ),
        ),
        _ActionCard(
