...
class UserNotifier extends StateNotifier<AsyncValue<List<User>>> {
  ...
  Future<List<User>> fetchStudents() async {
    try {
      return await _repository.fetchStudents();
    } catch (e) {
      rethrow;
    }
  }
  ...
  // NUEVO: Actualizar información del usuario (nombre, correo)
  Future<void> updateUserInfo(int id, Map<String, dynamic> data) async {
    try {
      await _repository.updateUserInfo(id, data);
      await fetchAllUsers();
    } catch (e, stack) {
      state = AsyncValue.error(e, stack);
    }
  ...
  // NUEVO: Actualizar información del estudiante (nombre, correo)
  Future<void> updateStudentInfo(int id, Map<String, dynamic> data) async {
    try {
      await _repository.updateStudentInfo(id, data);
      await fetchAllUsers();
    } catch (e, stack) {
      state = AsyncValue.error(e, stack);
    }
